...
const CellNotifTab = ({ item }) => {
  ...
  var repliedto= ''
  var itemData = item.replyTo;
  const getRepliedTo = () => {
      for (var i in item.replyTo) {
          if (i == 0) {
            repliedto += itemData[i]
          } else {
            if (i == (itemData.length -1)) {
                repliedto += ' dan ' + itemData[i]
            } else {
              repliedto += " , " + itemData[i]
            }
          }
  ...
  return (
    ...
    >
      ...
      <View style={{ flex: 1 }}>
        ...
        <View>
        <Text style={{ marginRight: 30, marginLeft: 13, fontSize: 16,  color:"#687887"}}>
        Membalas <Text style={{color: "#1ca1f2"}}>{getRepliedTo()}</Text>
          </Text>
        </View>
        <View>
        ...
        >
          ...
          >
            ...
            <Text style={{ marginLeft: 7 }}>
              {countReply !== 0 ? countReply : <View></View>}
            </Text>
          </View>
          <View
            style={{
          ...
          >
            ...
            />
            <Text style={{ marginLeft: 7 }}>
              {countLike !== 0 ? countLike : <View></View>}
            </Text>
          </View>
          <View
            style={{
